...
|---|---:|---:|---:|---:|---:|---:|---:|
| compkey_current | 53 | 0.2478 | 0.3212 | 0.4851 | 1.0000 | 0.1246 | 0.0139 |
| cooccur_freq | 53 | 0.2852 | 0.3433 | 0.6069 | 1.0000 | 0.0754 | 0.0073 |
| tfidf | 53 | 0.2695 | 0.3401 | 0.4945 | 1.0000 | 0.0970 | 0.0091 |
| pmi | 53 | 0.1435 | 0.1892 | 0.4538 | 1.0000 | 0.1572 | 0.0160 |
| bm25 | 53 | 0.1998 | 0.2281 | 0.4538 | 1.0000 | 0.1967 | 0.0142 |

## 4. 结论（基于本次实测）

- Recall@10 最优：`cooccur_freq`（0.3433）
- MRR@10 最优：`cooccur_freq`（0.6069）
- 无缓存延时最优：`cooccur_freq`（0.0754 ms）

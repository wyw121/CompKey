...
|---|---:|---:|---:|---:|---:|---:|---:|
| compkey_current | 53 | 0.3529 | 0.3850 | 0.6522 | 1.0000 | 0.0946 | 0.0092 |
| cooccur_freq | 53 | 0.3706 | 0.3991 | 0.6571 | 1.0000 | 0.1457 | 0.0072 |
| tfidf | 53 | 0.3529 | 0.3960 | 0.6508 | 1.0000 | 0.1380 | 0.0208 |
| pmi | 53 | 0.2592 | 0.3034 | 0.6353 | 1.0000 | 0.1001 | 0.0090 |
| bm25 | 53 | 0.3130 | 0.3420 | 0.6353 | 1.0000 | 0.1611 | 0.0139 |

## 4. 结论（基于本次实测）

- Recall@10 最优：`cooccur_freq`（0.3991）
- MRR@10 最优：`cooccur_freq`（0.6571）
- 无缓存延时最优：`compkey_current`（0.0946 ms）

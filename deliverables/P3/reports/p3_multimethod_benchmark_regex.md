...
|---|---:|---:|---:|---:|---:|---:|---:|
| compkey_current | 53 | 0.1321 | 0.1368 | 0.1250 | 1.0000 | 0.0878 | 0.0111 |
| cooccur_freq | 53 | 0.1321 | 0.1368 | 0.1250 | 1.0000 | 0.0350 | 0.0054 |
| tfidf | 53 | 0.1321 | 0.1368 | 0.1250 | 1.0000 | 0.0560 | 0.0043 |
| pmi | 53 | 0.1321 | 0.1368 | 0.1250 | 1.0000 | 0.0509 | 0.0063 |
| bm25 | 53 | 0.1321 | 0.1368 | 0.1250 | 1.0000 | 0.0863 | 0.0116 |

## 4. 结论（基于本次实测）

- Recall@10 最优：`compkey_current`（0.1368）
- MRR@10 最优：`compkey_current`（0.1250）
- 无缓存延时最优：`cooccur_freq`（0.0350 ms）
